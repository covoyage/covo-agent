...
// NewApprovalBridge wraps an approval system for the permission gate.
func NewApprovalBridge(system *approval.System) *ApprovalBridge {
	return &ApprovalBridge{System: system}
}
