...
Call `sessions_spawn` directly — it is NOT available inside execute_code or scripts.
...
- **sessions_spawn returns non-JSON** — retry once with stricter prompt, then treat as FAIL
