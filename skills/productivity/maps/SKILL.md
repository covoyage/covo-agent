...
- User sends a location pin (latitude/longitude in the message) → `nearby`
...
Script path: `~/.covo-agent/skills/productivity/maps/scripts/maps_client.py`

## Commands

```bash
MAPS=~/.covo-agent/skills/productivity/maps/scripts/maps_client.py
```
...
```bash
python3 ~/.covo-agent/skills/productivity/maps/scripts/maps_client.py search "Statue of Liberty"
# Should return lat ~40.689, lon ~-74.044

python3 ~/.covo-agent/skills/productivity/maps/scripts/maps_client.py nearby --near "Times Square" --category restaurant --limit 3
