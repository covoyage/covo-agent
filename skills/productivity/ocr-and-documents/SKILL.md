...
For PPTX: use `python-pptx` with full slide/notes support.
...
```
web_fetch(url="https://arxiv.org/pdf/2402.03300", format="text")
web_fetch(url="https://example.com/report.pdf", format="text")
```
