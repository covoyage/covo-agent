...
func newDreamingCommand() *cobra.Command {
	...
	dreamingCmd.AddCommand(&cobra.Command{Use: "config [key=value...]", Short: "Show or set dreaming configuration", Args: cobra.ArbitraryArgs, RunE: func(_ *cobra.Command, args []string) error { cmdDreaming(append([]string{"config"}, args...)); return nil }})
	return dreamingCmd
}
