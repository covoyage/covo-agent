...
func newSkillCommand() *cobra.Command {
	...
	skillCmd.AddCommand(&cobra.Command{Use: "search <term>", Short: "Search for skills", Args: cobra.ExactArgs(1), RunE: func(_ *cobra.Command, args []string) error { cmdSkills(prependArg("search", args)); return nil }})
	skillCmd.AddCommand(&cobra.Command{Use: "info <name>", Short: "Show skill details", Args: cobra.ExactArgs(1), ValidArgsFunction: completeSkillNames, RunE: func(_ *cobra.Command, args []string) error { cmdSkills(prependArg("info", args)); return nil }})
	skillCmd.AddCommand(&cobra.Command{Use: "disable <name>", Short: "Disable a skill", Args: cobra.ExactArgs(1), ValidArgsFunction: completeSkillNames, RunE: func(_ *cobra.Command, args []string) error { cmdSkills(prependArg("disable", args)); return nil }})
	skillCmd.AddCommand(&cobra.Command{Use: "enable <name>", Short: "Re-enable a disabled skill", Args: cobra.ExactArgs(1), ValidArgsFunction: completeSkillNames, RunE: func(_ *cobra.Command, args []string) error { cmdSkills(prependArg("enable", args)); return nil }})
	...
	configCmd.AddCommand(&cobra.Command{Use: "set <key> <value>", Short: "Set a skill configuration value", Args: cobra.ExactArgs(2), RunE: func(_ *cobra.Command, args []string) error { cmdSkills([]string{"config", "set", args[0], args[1]}); return nil }})
	...
	hubCmd.AddCommand(&cobra.Command{Use: "install <name>", Short: "Install a skill from the hub", Args: cobra.ExactArgs(1), RunE: func(_ *cobra.Command, args []string) error { cmdSkills([]string{"hub", "install", args[0]}); return nil }})
